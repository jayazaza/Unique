	...
	LoadButton.MouseButton1Down:Connect(function()
		if LoadFocus == false then
			...
			repeat wait()
				...
				TitleLoad.Text = "Get Patch DAD  Script Version : 3.0.0"
				wait(0.35)
				TweenService:Create(
					TitleLoad,
					TweenInfo.new(.5, Enum.EasingStyle.Quart, Enum.EasingDirection.InOut),
				...
				TitleLoad.Text = "Welcome to DAD Script | Premium Edition"
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder(" X Hub Premium Scripts") then
			makefolder("DADX Hub Premium Scripts")
		end
		if not isfolder("DAD X Hub Premium Scripts/Blox Fruits/") then
			makefolder("DAD X Premium Scripts/Blox Fruits/")
		end
		if not isfile("DAD X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("DAD X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("DAD X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("DAD X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("DAD X Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
if World1 then
	TeleportTable = {"Jones DAD","Marine1","Marine2","Midle Town","Jungle","Pirate Village","Desert","Frozen Village","Colosseum","Prison","Mob Leader","Magma Village","UnderWater Gate","UnderWater City","Fountain City","Sky1","Sky2","Sky3"}
elseif World2 then
...
Page_Teleports.Button({
	...
	callback = function(value)
		if World1 then
			if _G.SelectLocalTeleport == "Jones DAD" then
...
-- local CreditL = Page_Credits.Label({Title = "Made By DAD X Team"})
